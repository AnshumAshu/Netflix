    ...
    fetch(
      ...
      .then((res) => {
        ...
        if (res.results.length > 0) {
          ...
          setcoming(res.results[randomIndex]);
        }
      })
    ...
    <div className="text-white md:px-4">
      ...
      {coming && (
        <div className="relative mb-10 mt-5">
          <img
            src={`https://image.tmdb.org/t/p/original/${coming.backdrop_path}`}
            alt={coming.title || "Hero Movie"}
      ...
      <h2 className="pt-10 pb-5 text-lg font-medium">Upcoming Movies</h2>
